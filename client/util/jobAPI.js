...
export default {
    ...
    getNewJobs: function() {
        return axios.get(`http://api.adzuna.com:80/v1/api/jobs/gb/search/1?app_id=${job_id}&app_key=
        ${job_key}&results_per_page=20&what=""&where=losangeles1&content-type=application/json`);
    },
